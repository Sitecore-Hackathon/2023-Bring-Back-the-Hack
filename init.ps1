...
$workinDirectoryPath = ".\run\sitecore-xm1-sxa"
...
Add-HostsEntry "cm.hackback.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.hackback.localhost"
}
Add-HostsEntry "id.hackback.localhost"
Add-HostsEntry "www.hackback.localhost"
Add-HostsEntry "styleguide.hackback.localhost"
...
if ($false) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.hackback.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.hackback.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.hackback.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.hackback.localhost"
